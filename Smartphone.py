...
f = open(
    "C:/Users/IBM_ADMIN/AppData/Roaming/Neo4j Desktop/Application/neo4jDatabases/database-7f83e15b-2553-485c-ac9b-8721d02222e6/installation-3.3.3/import/smartphone.txt", "a")
#print(len(rows))
...
f.close()
f1 = open(
    "C:/Users/IBM_ADMIN/AppData/Roaming/Neo4j Desktop/Application/neo4jDatabases/database-7f83e15b-2553-485c-ac9b-8721d02222e6/installation-3.3.3/import/smartphone.txt", "r")
data=f1.read()
